...
public class NavigationController {
    ...
    public String navigation(Model model) {
        ...
        model.addAttribute("siteConfig", service.findSiteConfig());
        return "navigation";
    }
    ...
    public SiteConfig updateSiteConfig(@Valid SiteConfig siteConfig) throws IOException {
        return service.updateSiteConfig(siteConfig);
    }
}
